...
当然了，后续可能会有查给分等功能，需要用到后台服务器。但请放心，Ham在传输你的信息时，务必通过你的同意。而且Ham不会直接传输关键信息（学号、密码等）。你的关键信息（学号等）在进行哈希运算后再传输至服务器，这样我也不知道是谁的成绩。~~（当然，这个还没做就是了，嘻嘻）~~**(2021.12.20更新，Android版已经写完了)(2021.12.23更新，iOS版已经写完了，提前祝大家圣诞快乐🎄)**
